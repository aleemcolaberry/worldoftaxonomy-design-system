...
const sizeBlocks: SizeBlock[] = [
  { label: 'Base', fontSize: '14px', lineHeight: '22px', variants: [
  ...
  { label: 'SM', fontSize: '12px', lineHeight: '20px', variants: [
  ...
  { label: 'LG', fontSize: '16px', lineHeight: '24px', variants: [
  ...
  { label: 'XL', fontSize: '20px', lineHeight: '28px', variants: [
  ...
  return (
    <AppShell>
      <PageIntro
        ...
        title="Text Styles"
        lede="Four body sizes (SM / Base / LG / XL) paired with a five-step heading scale. All weights render in Geist; mono styles use Geist Mono."
      />
